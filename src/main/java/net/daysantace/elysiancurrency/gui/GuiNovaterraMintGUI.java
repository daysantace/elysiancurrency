...
package net.daysantace.elysiancurrency.gui;
...
public class GuiNovaterraMintGUI extends ElementsElysiancurrencyMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiNovaterraMintGUI(ElementsElysiancurrencyMod instance) {
		super(instance, 18);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("elysiancurrency:textures/novaterramintgui.png");
		@Override
		...
		public void updateScreen() {
			super.updateScreen();
			denomcount.updateCursorCounter();
		}

		@Override
		protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
			denomcount.mouseClicked(mouseX - guiLeft, mouseY - guiTop, mouseButton);
			super.mouseClicked(mouseX, mouseY, mouseButton);
		}

		@Override
		protected void keyTyped(char typedChar, int keyCode) throws IOException {
			denomcount.textboxKeyTyped(typedChar, keyCode);
			if (denomcount.isFocused())
				return;
		...
		public void initGui() {
			...
			denomcount = new GuiTextField(0, this.fontRenderer, 27, 20, 120, 20);
			guistate.put("text:denomcount", denomcount);
			denomcount.setMaxStringLength(32767);
			denomcount.setText("Denomination value");
			this.buttonList.add(new GuiButton(0, this.guiLeft + 67, this.guiTop + 46, 40, 20, "Mint"));
		}
