...
public class ItemNovaterraPoundFiveHundred extends ElementsElysianCurrency.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("elysiancurrency:novaterrapoundfivehundred", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("novaterrapoundfivehundred");
			setRegistryName("novaterrapoundfivehundred");
